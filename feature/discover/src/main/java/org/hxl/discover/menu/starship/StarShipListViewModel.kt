...
@HiltViewModel
class StarShipListViewModel @Inject constructor(getStarShip: StarShipUseCase, getFavorite: FavoriteStarShipUseCase):
    BaseListViewModel<StarShip>(getStarShip, getFavorite)