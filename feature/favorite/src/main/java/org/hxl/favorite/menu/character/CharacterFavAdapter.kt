...
class CharacterFavAdapter: BaseAdapter<Character, CharacterListAdapter.CharacterViewHolder>(CharacterItemCallBack) {
    override fun getViewHolder(
        parent: ViewGroup?,
        viewType: Int
    ): CharacterListAdapter.CharacterViewHolder {
        val binding = CharacterItemBinding.inflate(LayoutInflater.from(parent?.context), parent, false)
        return CharacterListAdapter.CharacterViewHolder(binding)
    }
}